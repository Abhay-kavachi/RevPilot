...
| **Probability Guardrail** | Scale-aware policy overriding pure expected value when high-probability actions are economically near-equivalent. | [`backend/app/economics/engine.py`](file:///C:/Users/abhay/OneDrive/Documents/Projects/RevPilot/backend/app/economics/engine.py) |
| **Portfolio MCKP Optimizer** | Dynamic programming knapsack solver maximizing yield under recovery capital constraints. | [`backend/app/economics/portfolio.py`](file:///C:/Users/abhay/OneDrive/Documents/Projects/RevPilot/backend/app/economics/portfolio.py) |
| **Shadow Price Calculation** | Discrete marginal budget value calculation evaluating the economic worth of relaxing capital constraints. | [`backend/app/economics/portfolio.py`](file:///C:/Users/abhay/OneDrive/Documents/Projects/RevPilot/backend/app/economics/portfolio.py) |
| **Temporal Deferral Simulator** | Deterministic simulation evaluating if waiting for organic recovery is better than acting now. | [`backend/app/economics/temporal.py`](file:///C:/Users/abhay/OneDrive/Documents/Projects/RevPilot/backend/app/economics/temporal.py) |
...
If you run `pytest .` in the `backend/` directory, the architectural boundaries are verified automatically (82 tests passed; 1 Razorpay external-integration test skipped because the Test Mode environment limit was reached). 
